...
- [x] **`intro-ficciones.mp3` + `outro-ficciones.mp3` generados con voz Gabo 2026-04-27 PM tarde** (regenerados desde Luis) tras decisión Rafael *"100% Gabo desde el siguiente relato"*. Duraciones Gabo: intro 2.83s · outro 8.68s. Bumpers Luis previos versionados como `intro-ficciones-luis-v1.mp3` y `outro-ficciones-luis-v1.mp3` (no borrados — regla never overwrite). Script de regeneración: [`utilities/_archive/generate_bumpers_gabo_2026_04_27.py`](../utilities/_archive/generate_bumpers_gabo_2026_04_27.py). **Histórico:** los 3 publicados pre-cambio voz default (la-objecion, el-operador-nocturno, el-que-viene-a-tomar-cafe) + pipo (publicado 2026-04-27 AM con Luis bumpers + Gabo cuerpo) NO se regeneran retroactivamente — quedan como histórico de la transición. Convención `ROBO, OGAR` (con coma) validada en bumpers Gabo igual que en Luis.
