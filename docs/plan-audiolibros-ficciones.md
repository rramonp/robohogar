...
- [x] **`intro-ficciones.mp3` + `outro-ficciones.mp3` con voz Luis** (canon híbrido restaurado 2026-04-28: bumpers Luis + cuerpo Gabo). Histórico de la decisión:
  1. **2026-04-22:** intro/outro Luis generados originalmente en FASE 0. Duraciones: intro 2.53s · outro 11.89s.
  2. **2026-04-27 PM tarde:** bumpers regenerados a Gabo tras decisión transitoria *"100% Gabo desde el siguiente relato"*. Duraciones Gabo: intro 2.83s · outro 8.68s. Script puntual: [`utilities/_archive/generate_bumpers_gabo_2026_04_27.py`](../utilities/_archive/generate_bumpers_gabo_2026_04_27.py).
  3. **2026-04-28:** Rafael revierte: *"nos quedamos con intro y outro voz de Luis y voz del relato Gabo"*. Bumpers Luis restaurados como canónicos `intro-ficciones.mp3` / `outro-ficciones.mp3`. Bumpers Gabo del 27 versionados como `intro-ficciones-gabo-v1.mp3` / `outro-ficciones-gabo-v1.mp3` (regla never overwrite). Backups Luis previos siguen en `intro-ficciones-luis-v1.mp3` / `outro-ficciones-luis-v1.mp3` por compatibilidad histórica.
  
  **Histórico de relatos publicados:** los 3 pre-cambio (la-objecion, el-operador-nocturno, el-que-viene-a-tomar-cafe) son 100% Luis. Pipo (2026-04-27 AM) es Luis bumpers + Gabo cuerpo — coincide con el canon híbrido restaurado. Ningún relato publicado se regenera retroactivamente. Convención `ROBO, OGAR` (con coma) validada en ambas voces.
