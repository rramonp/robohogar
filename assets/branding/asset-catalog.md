...
| 14 | `robot-cortacesped-rentabilidad-3-anos` (**v2**) | 2026-04-28 | Editorial/Guía (ROI) | 2 (gemini-3.1-flash-image-preview) | **Hero rotado v1 → v2 el 2026-04-28 PM tras revisión de Rafael.** Yuxtaposición editorial fuerte: cortacésped manual de gasolina rojo abandonado a la izquierda sobre césped descuidado + bidón de combustible · robot cortacésped moderno blanco trabajando a la derecha sobre césped a rayas · muro de piedra mediterráneo y olivos al fondo. Plano medio bajo, luz natural neutra. Comunica el contraste editorial *"qué hacías hoy → qué vas a hacer a partir de ahora"* — alineado con la tesis del artículo de forma más directa que v1. 3 variantes generadas con composiciones genuinamente distintas: v1 lifestyle (chalet + pareja terraza, archivada), **v2 yuxtaposición (elegida)**, v3 close-up product hero (archivada). **Primer artículo en cumplir el refuerzo "3 candidatos = 3 ideas/composiciones/planos distintos" del 2026-04-28**. |
...
| 6 | One-shot | `el-cristalero` | 2026-04-28 | v2-c09 (elegido por Rafael · C-07/C-12 archivados como no-elegidos) | personaje-acción-imposibilidad | — (G4 family, banda no aplica) | C-09 over-the-shoulder voyeur (familia IV frontal/OTS) | Rosa de carbón en cristal escarchado a 30+ plantas (objeto-imposibilidad: el carbón sobre cristal escarchado nocturno como evento clasificable que el bot archiva) | Robot CUSTODIA-2 patrullero matt graphite en silueta foreground OTS (gen previa a VELA-9, sin LEDs, sin glow, sin ojos lit, cabeza torcida tres grados a la izquierda). Detrás del cristal frosted: limpiacristales boliviano 50+ Wilmer Ayala colgado de cables · mono azul + casco blanco + arnés con dos cabos. Rosa centrada en el cristal entre robot y cleaner. Cielo cobalto-noche con nubes detrás del cleaner (sin ciudad, sin neones, sin Asian script). Foco lumínico ámbar único cálido cayendo desde techo de oficina sobre rosa + cleaner. Modalidad M2 cobalto tormenta (primer uso · paleta cyan-cobalto deep + foco ámbar) · ángulo A1 lateral eye-level. Painterly Hopper-Caravaggio. v1-c07 archivada (Penguin Modern Classics frame literal + ojos rojos robot) · v1-c09 archivada (neones cyberpunk + Asian script) · v2-c07 + v1-c12 archivados como candidatos no elegidos. |
