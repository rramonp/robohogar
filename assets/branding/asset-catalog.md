...
| 14 | `robot-cortacesped-rentabilidad-3-anos` (v1) | 2026-04-28 | Editorial/Guía (ROI) | 2 (gemini-3.1-flash-image-preview) | Lifestyle "tiempo recuperado": chalet español al atardecer, jardín cuidado a rayas, robot cortacésped trabajando solo en plano medio, pareja al fondo en terraza con dos cafés y un libro. Wide establishing shot golden hour, paleta ámbar mediterránea. Comunica la tesis del artículo (rentabilidad = recuperar tiempo) en un solo vistazo. 3 variantes generadas con composiciones genuinamente distintas: v1 lifestyle (elegida), v2 yuxtaposición vieja-vs-nueva (cortacésped manual oxidado a la izquierda + robot moderno a la derecha — buena para social cuando toque), v3 close-up product hero del robot solo. v2 y v3 archivadas en `assets/_archive/`. **Primer artículo en cumplir el refuerzo "3 candidatos = 3 ideas/composiciones/planos distintos" del 2026-04-28**. |
