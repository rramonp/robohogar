...
palabras: 3120
version: 3
personajes: [Martín García, Joel Santos, portavoz corporativo]
pov: omnisciente-cercano-rotando
tiempo-verbal: presente
tag: Ficciones Domésticas
tags-beehiiv: [Opinión]
dato-real: "1X NEO (humanoide doméstico comercial 2026-2032) emplea teleoperación humana remota para tareas no resueltas por la IA. Los humanoides comerciales tienen altavoz bidireccional para 'mensajes empresa' (avisos, confirmaciones); el panel del operador permite reproducir audio sintetizado pero el log solo registra 'audio output' sin inspeccionar contenido. Deal 1X+EQT (12-abr-2026): 10.000 unidades industriales. AI Act art. 50: obligación de transparencia cuando agente IA interactúa con personas."
villano-humano: "Gig economy del sur global + soledad inducida del operador + dark patterns en el panel que permiten construir rutina íntima con un cliente sin auditoría suficiente. Joel también es víctima del sistema que lo deja solo nueve horas con la cocina ajena."
left-wall: "Humanoide doméstico comercial 2032 con altavoz bidireccional. El sistema de reconocimiento óptico falla en tareas nuevas (cartón rediseñado) y llama a operador humano. El operador puede reproducir audio sintetizado a través del altavoz; el log lo registra como 'audio output ID' sin guardar el contenido sonoro generado. Call center filipino, 3-5 USD/hora."
big-lie: "El panel del operador permite calibrar audio sintetizado al umbral de sueño infantil con precisión de milisegundos a partir de los datos biométricos pasivos del hogar (ritmo respiratorio captado por el micro ambiental del humanoide). Plausible técnicamente; impensable como uso documentado."
framework: pixar-spine-adaptado
categoria-tonal: inquietante-heavy
status: borrador-v3
created: 2026-04-19
updated: 2026-04-19
...
> **Mentira grande:** el panel del operador permite calibrar audio sintetizado al umbral de sueño infantil con precisión de milisegundos a partir de la biometría pasiva del hogar. Plausible técnicamente; impensable como uso documentado.
> **Muro izquierdo:** humanoide doméstico comercial 2032 con altavoz bidireccional para mensajes empresa; el log registra "audio output ID" sin inspeccionar el contenido sintetizado. Call centers filipinos sostienen el 20% de tareas no resueltas por IA.
> *Registradas por `/ficcion-draft` · cambiar antes de publicar si no encajan.*

---

## I. Madrid — un martes a las tres y catorce
...
<!-- villano-humano: la gig economy del sur global que deja al operador filipino solo nueve horas con la cocina ajena, y los dark patterns del panel que permiten construir un ritual íntimo con un cliente sin auditoría suficiente. Joel también es víctima — perdió a su hijo Aldwin hace cuatro años y busca reconstruir el ritual de "ver a un crío despierto a deshora" sin tocar nada físico. El sistema le permite hacerlo sin que nadie lo detecte. El robot NO es villano — es instrumento neutro. El portavoz tampoco: también cree su propio discurso. El villano es el sistema de plausibilidad que permite que todos duerman menos uno. -->
<!-- v3 (2026-04-19): vuelta de tuerca inquietante-heavy. Joel ha estado calibrando audio sintetizado (clic del imán, compresor) durante 7 noches para inducir el despertar del niño y verle la cara — sustituye el ritual de su hijo perdido. Incluye foreshadowing en escena 1 (compresor más alto, clic más largo, conteo del cuarto martes seguido), revelación en escena 2 (panel muestra patrón recurrente sesión 7, biometría pasiva, mención Aldwin), cierre escena 3 con Martín entendiendo y eligiendo no bajar — el sistema sube el ruido. Aplica regla anclaje 1×humanoide por escena (skill /ficcion-draft § 6) + nombres distinguibles (Joel ≠ Martín) + categoria-tonal: inquietante-heavy. -->
