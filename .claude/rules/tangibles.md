...
- **Promoción del tangible en artículos: banner Dark oficial.** Scope **estricto** del banner Hoja de Compra (tangible decidiendo-compra de aspirador/cortacésped): solo categorías consumer donde la intención del lector es "voy a gastarme 500-1.500 € en un robot y no quiero equivocarme" — `aspirador · cortacésped · fregasuelos · limpia-cristales`. Banner en **2 posiciones** (tras intro + tras veredicto) si >1.500 palabras; solo final si <800.
  - **Exclusiones totales** (NO banner Hoja de Compra): `humanoide` · `mascota-robot` · `asistente-ia-escritorio` · `ficcion` · `editorial-sin-angulo-compra`.
  - **Por qué excluir mascota-robot / asistente-ia** (actualizado 2026-04-19 tras rechazo de Rafael sobre `mejor-robot-asistente-ia-2026`): el tangible responde a preguntas de aspirador (succión, fregado, estación, LiDAR, precio/m²) que NO aplican al lector de Loona/LOOI/Eilik. Promocionar Hoja de Compra en esos artículos → suscriptor incorrecto → churn en welcome + riesgo spam report → ensucia el funnel. Esperar tangible específico "Guía del asistente IA de escritorio" / "Mascota-robot: qué esperar y qué no" (pendiente F2).
  ...
  - Regla activa desde 2026-04-18; scope ajustado 2026-04-19.
