...
- **Microtensión sentence-level — OBLIGATORIO** (regla dura 2026-04-28 PM tras auditoría de 5 relatos publicados). Cada **párrafo** del relato debe contener al menos uno de los 4 vectores de microtensión (conflicto interior · contradicción · pregunta latente · cambio de estado emocional). Toolkit con 8 técnicas + ejemplos extraídos del catálogo en [`@references/ficciones/microtension-sentence-level.md`](../../references/ficciones/microtension-sentence-level.md). **Verificación pre-output:** test del párrafo aburrido §4 — leer cada párrafo aislado, scorear 1-5. Score promedio meta: ≥4.0 para Cinematográfico/Dinámico · ≥3.5 Atmosférico · ≥3.0 Slice. Cualquier párrafo con score ≤2 → reescribir o cortar (excepto 1 respiradero documentado cada ~400 palabras). Frontmatter `microtension_score:` declarado tras revisión. Aplica desde el siguiente relato (one-shots y miniseries futuras); series activas (Amparo/Ronda 3/MAIA) mantienen su código.

- **Consecuencia visible post-decisión — OBLIGATORIO en Cinematográfico y Dinámico** (regla dura 2026-04-28 PM, hermana de microtensión). Todo relato Cinematográfico o Dinámico cierra con un **acto / diálogo / reacción exterior inmediatamente posterior** a la decisión irreversible. **No se permite cerrar con silencio meditativo, descripción atmosférica o reflexión interior tras la decisión central.** Atmosférico y Slice sí permiten cierre meditativo. Detalle, ejemplos auditados (Pipo ✅ · La objeción ⚠️ acto-suspendido · Setenta y dos horas ❌ · La maratonista válido como Atmosférico) + estructura del cierre canónico en [`@references/ficciones/intensidad-narrativa.md § 2.bis`](../../references/ficciones/intensidad-narrativa.md). **Verificación pre-output:** leer últimas 5-7 líneas del borrador, identificar al menos uno de los tres elementos (acto / diálogo / reacción visible de otro). Si no hay ninguno y la categoría declarada es Cinematográfico/Dinámico → bloqueo + reescribir. Frontmatter `cierre_tipo:` declarado (uno de `consecuencia-visible · suspendido-acto · meditativo · silencio-moral · reaccion-otro`). Excepción declarada: `acto-irreversible-suspendido` cumple regla porque la suspensión visible es la consecuencia (caso La objeción). Aplica solo a one-shots y miniseries futuras.

- **Show don't tell — checklist obligatorio + grep pre-output** (regla dura 2026-04-28 PM). Lista cerrada de **10 verbos cognitivos** (*pensó · sintió · recordó · supo · entendió · se dio cuenta · comprendió · tuvo la sensación · le pareció · creyó*) y **10 adjetivos-juicio** (*triste · feliz · enfadado · cansado · nervioso · agobiado · solitario · vacío · preocupado · abrumado*) prohibidos en narrador, con sustitución gestual canónica para cada uno. Telling permitido solo en 3 casos documentados (transición temporal rápida · recursión a info ya mostrada · economía en flash). Detalle + grep canónico §4 + auditoría inversa de los 5 relatos en [`@references/ficciones/show-dont-tell-operativo.md`](../../references/ficciones/show-dont-tell-operativo.md). **Verificación pre-output:** ejecutar 4 greps de §4 sobre el borrador. Bloqueo automático si §4.3 (anti-patterns combinados *de repente · una sensación de X lo invadió · algo en su interior*) ≥1 match o §4.4 (adverbios *-mente* en cadena) ≥1 match. Para §4.1 verbos cognitivos y §4.2 adjetivos-juicio: cada match revisado manualmente — legítimo (diálogo, DIL puro, telling permitido §3 documentado) ✅; si no → reescribir. Meta total ≤3 matches reescribibles por relato (baseline auditada: ~12 matches en los 5 relatos previos). Aplica solo a one-shots y miniseries futuras.
...
Microtensión sentence-level (8 técnicas Maass adaptadas a ES doméstico): `@references/ficciones/microtension-sentence-level.md`.
Diálogo ES doméstico (4 funciones McKee + 6 técnicas subtexto + decisión-en-voz-alta): `@references/ficciones/dialogo-es-domestico.md`.
Open loops y curiosity gaps (3 niveles + 6 tipos pregunta + payback): `@references/ficciones/open-loops-curiosity-gaps.md`.
POV y discurso indirecto libre (tabla decisión + 4 marcadores DIL + POV humanoide): `@references/ficciones/pov-y-discurso-indirecto-libre.md`.
Show don't tell operativo (10 verbos cognitivos + 10 adjetivos-juicio + grep): `@references/ficciones/show-dont-tell-operativo.md`.
