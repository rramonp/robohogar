# Fuentes por Categoría — ROBOHOGAR

Archivo vivo de fuentes verificadas, organizadas por content tags de Beehiiv.
Criterio: solo fuentes con contenido editorial real (no promocional).
...
Robots de escritorio/compañeros con LLM integrado (ChatGPT, GPT-4o).

### Fuentes independientes (EN)

| Fuente | URL | Tipo | Notas |
|--------|-----|------|-------|
| Robots Around The House | robotsaroundthehouse.com | Foro/comunidad | El mejor foro de companion robots. Secciones por robot, alertas de fraude |
| Mia Cat | mia-cat.com/en/pet-robot/ | Blog reviews | Reviews detalladas de Emo, LOOI, Moflin, ElliQ |
| CyberNews AI Tools | cybernews.com/ai-tools/best-ai-robot-pets/ | Comparativa | Comparativa 6 AI robot pets (actualizada 2026) |
| The Gadgeteer | the-gadgeteer.com | Blog reviews | Review honesta Miko 3: "tablet disfrazada de robot" |
| Serious Insights | seriousinsights.net | Blog analítico | Review analítica de Miko 3 |
| LivingAI Forums | forums.living.ai | Foro oficial | Usuarios reales (muchos frustrados) — buen termómetro |
| Trustpilot — Living.ai | trustpilot.com/review/living.ai | Reviews usuarios | 2.4/5 (47 reviews). Quejas: bugs, caídas, soporte |

### Fuentes independientes (ES)

| Fuente | URL | Tipo | Notas |
|--------|-----|------|-------|
| Xataka — Robótica e IA | xataka.com/categoria/robotica-e-ia | Medio tech | Cobertura constante. Editorial fuerte |
| FayerWayer | fayerwayer.com | Medio tech LATAM | "15 robots que ya viven contigo" — guía 2026 |
| Robot in House | robotinhouse.com/blog-sobre-robotica-domestica/ | Blog español | Competidor directo. Robótica doméstica en español |

### Robots en esta categoría

| Robot | Marca | Precio | Valoración real |
|-------|-------|--------|-----------------|
| EMO (Go Home) | Living.ai | $279-$369 | Trustpilot 2.4/5. Bugs, soporte malo |
| Eilik | Energize Lab | ~$140 | +60K vendidos. Cumple lo que promete. Sin suscripción |
| LOOI | TangibleFuture | $159-$189 | Acopla smartphone. Novedad puede desgastarse |
| Vector 2.0 | Digital Dream Labs | ~$399 + suscripción | Empresa con problemas financieros. Mercado segunda mano inundado |
| Miko 3 | Miko | $200-$300 + $99/año | Para niños. Pantalla se congela, voz inconsistente |
| ElliQ | Intuition Robotics | $249 + $59/mes | Para mayores. Líder en su categoría |

---

## Robot Mascotas

Robots tipo mascota/pet con IA emocional.

### Fuentes independientes (EN)

| Fuente | URL | Tipo | Notas |
|--------|-----|------|-------|
| TechCrunch | techcrunch.com (buscar: Moflin, Loona, companion robot) | Medio tech | Review Moflin tras 1 mes de convivencia real |
| Rolling Stone | rollingstone.com (buscar: Moflin review) | Magazine | Review crítica: "señal de nuestra realidad deprimente" |
| Fast Company | fastcompany.com (buscar: Moflin review) | Magazine | "Me encariñé contra mi voluntad" |
| Tom's Guide | tomsguide.com | Reviews tech | Reviews Ecovacs LilMilo, Moflin, Sony Aibo |
| IEEE Spectrum | spectrum.ieee.org | Técnico/académico | Pros/contras de companion robots |

### Fuentes independientes (ES)

| Fuente | URL | Tipo | Notas |
|--------|-----|------|-------|
| Xataka Smart Home | xatakahome.com | Medio tech | IA aplicada al hogar |
| Infobae Tecno | infobae.com/tecno/ | Medio LATAM | Cobertura robots humanoides/domésticos |

### Robots en esta categoría

| Robot | Marca | Precio | Valoración real |
|-------|-------|--------|-----------------|
| Loona | KEYi Tech | ~$500 | 4.8/5 (1000+ reviews). Mejor relación calidad/precio. Sin suscripción |
| Moflin | Casio | ~$430 | Reviews mixtas. Motor ruidoso. "No pagaría $430 yo mismo" |
| Sony Aibo | Sony | $2,899 + $300/año | Ultra-realista pero carísimo. Suscripción obligatoria |
| LOVOT | GrooveX | $3,000+ | 90% uso activo tras 1000 días. Solo Japón. Empresa con -$54M |
| LilMilo | Ecovacs | Sin precio | CES 2026. Bichón Frisé robótico. Ecovacs pivotea de aspiradores a pets |
| Tombot Jenny | Tombot | Sin precio | CES 2026. Labrador terapéutico. Sin reviews aún |

---

## Humanoides

Robots humanoides para tareas domésticas.
...
| BOE RD 2177/2004 trabajos verticales | boe.es/buscar/act.php?id=BOE-A-2004-19311 | Regulatorio ES oficial | Real Decreto 2177/2004 sobre disposiciones mínimas de seguridad y salud para trabajos en altura con cables, formación y EPI. Marco legal ES de limpieza vertical en fachadas. Usado en relato "El cristalero" (28-abr-2026) como muro izquierdo del oficio de Wilmer. |
| epdata.es empleo extranjero limpieza | epdata.es/datos/empleo-extranjero-2017-numero-trabajadores-extranjeros-numero-asalariados-extranjeros-numero-asalariados/106/espana/106 | Datos / dossier ES | Dossier de epdata sobre presencia migrante en sectores ES. Limpieza entre los sectores con mayor presencia migrante. Usado en relato "El cristalero" para anclar el perfil sociolaboral de Wilmer. |
| Skyline Robotics | skylinerobotics.com | Fabricante oficial | Empresa de plataformas robotizadas de limpieza vertical de fachadas (drones de fachada operativos). Usado en relato "El cristalero" como referente real del relevo automatizado del oficio de cristalero. |
| Lucid Bots | lucidbots.com | Fabricante oficial | Drones de fachada operativos para limpieza vertical exterior. Complemento a Skyline. Usado en relato "El cristalero" como segundo referente real del relevo automatizado. |

### Fuentes independientes (ES)

| Fuente | URL | Tipo | Notas |
|--------|-----|------|-------|
| Xataka | xataka.com | Medio tech | "La carrera por meter un robot humanoide en casa... absurda" |
...
Reviews, comparativas, guías de compra de robots aspiradores.
...
Domótica, integración, ecosistemas inteligentes.

### Fuentes independientes (ES)

| Fuente | URL | Tipo | Notas |
|--------|-----|------|-------|
| Xataka Smart Home | xatakahome.com/tag/inteligencia-artificial | Medio tech | IA aplicada al hogar. Fuente principal en español |

### Fuentes independientes (EN)

*Pendiente: ampliar con fuentes específicas de domótica*

---

## Noticias

Fuentes para noticias de última hora en robótica doméstica.

### RSS feeds configurados

| Fuente | Feed | Idioma |
|--------|------|--------|
| The Robot Report | therobotreport.com/feed/ | EN |
| IEEE Spectrum Robotics | spectrum.ieee.org/feeds/topic/robotics.rss | EN |
| Weekly Robotics | weeklyrobotics.com/feed.xml | EN |
| Xataka Robots | xataka.com/tag/robots/feed | ES |
| Xataka Home | xatakahome.com/feed | ES |
| TechCrunch Robotics | techcrunch.com/tag/robotics/feed/ | EN |

### Fuentes para monitorizar (sin RSS conocido)
...
Fuentes con perspectiva editorial/debate sobre robótica y sociedad.

### Fuentes independientes

| Fuente | URL | Tipo | Notas |
|--------|-----|------|-------|
| IEEE Spectrum | spectrum.ieee.org | Técnico/académico | Artículos sobre impacto social de robots |
| Nature Machine Intelligence | nature.com/natmachintell/ | Académico | Pide atención urgente sobre robots compañeros y aislamiento |
...
Tutoriales, configuración, troubleshooting.

### Fuentes independientes

| Fuente | URL | Tipo | Notas |
|--------|-----|------|-------|
| Robots Around The House | robotsaroundthehouse.com | Foro | Guías y troubleshooting por modelo |
| LivingAI Forums | forums.living.ai | Foro | Soluciones comunitarias para Emo |

---

## YouTube — Canales de referencia

| Canal | Enfoque | Idioma |
|-------|---------|--------|
| Eric J. Kuhns | CES, companion robots, LOOI | EN |
| Lindsay (Robots Around The House) | Loona, companion robots | EN |
| Simone Giertz | Humor + robótica doméstica | EN |

*Pendiente: buscar canales en español*

---

## Notas

- **Competidor directo en español**: robotinhouse.com — monitorizar su contenido
- **Criterio de calidad**: si una fuente publica >50% contenido promocional, no se incluye aquí
- **Amazon affiliate**: los links de compra van en los artículos, no en este archivo
